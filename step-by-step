...
# 4. Deploy Jenkins Controller Autoscaling Group & Load Balancer
cd terraform/asg-lb
...
# 6.  Test Jenkins High Availability
...
# 7.  Patching & Upgrading Jenkins Controller
